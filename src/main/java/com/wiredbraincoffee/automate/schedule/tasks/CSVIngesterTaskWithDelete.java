package com.wiredbraincoffee.automate.schedule.tasks;

import com.wiredbraincoffee.SaleTransaction;
import com.wiredbraincoffee.automate.schedule.IngesterTaskWithDelete;
...
public class CSVIngesterTaskWithDelete extends IngesterTaskWithDelete {
    private CSVRecord record;

    public CSVIngesterTaskWithDelete(String sourceFilename, String targetFilename) {
